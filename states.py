...
class States(Enum):
    ...
    S_EDIT_STANDARD_MONDAY_MYCLASSES = 9
    S_EDIT_STANDARD_TUESDAY_MYCLASSES = 10
    S_EDIT_STANDARD_WEDNESDAY_MYCLASSES = 11
    S_EDIT_STANDARD_THURSDAY_MYCLASSES = 12
    S_EDIT_STANDARD_FRIDAY_MYCLASSES = 13
    S_EDIT_STANDARD_SATURDAY_MYCLASSES = 14
    S_EDIT_STANDARD_SUNDAY_MYCLASSES = 15

...
class States(Enum):
    ...
    S_ENTER_DIARY_PRIVILEGE_EDIT_ROLE_MEMBERS_SETTINGS = 33
    S_ENTER_MEMBERS_PRIVILEGE_EDIT_ROLE_MEMBERS_SETTINGS = 34
    S_ENTER_CLASSROOM_PRIVILEGE_EDIT_ROLE_MEMBERS_SETTINGS = 35
